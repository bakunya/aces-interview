...
*/ (function () {
				...
				'./src/to-svg.js': function (s, f, r) {
					...
					function p(h) {
						...
						if ((console.warn('feather.toSvg() is deprecated. Please use feather.icons[name].toSvg() instead.'), !h))
		...
		(function (s, f) {
			...
			function Ee(n, e, t) {
				return function i(o) {
					...
					for (let { target: d } = o; d && d !== this; d = d.parentNode)
						for (const y of c)
							if (y === d) return rn(o, { delegateTarget: d }), i.oneOff && x.off(n, o.type, e, t), t.apply(d, [o]);
				};
			}
				...
				_addEventListeners() {
					this._config.keyboard && x.on(this._element, oo, (e) => this._keydown(e)),
						this._config.pause === 'hover' &&
							(x.on(this._element, so, () => this.pause()), x.on(this._element, ao, () => this._maybeEnableCycle())),
			...
			function xi(n) {
				...
				if (M) {
					...
					if (
						(K === se(t) &&
							((K = Ce(t)), Ae(K).position !== 'static' && y === 'absolute' && ((G = 'scrollHeight'), (q = 'scrollWidth'))),
						(K = K),
						o === te || ((o === ne || o === oe) && c === rt))
					) {
						V = re;
			...
			function ds(n) {
				var e = n.state,
					...
					b = y.x,
					M = y.y;
				e.modifiersData.popperOffsets != null && ((e.modifiersData.popperOffsets.x += b), (e.modifiersData.popperOffsets.y += M)),
					(e.modifiersData[i] = d);
			}
				...
				_getPopperConfig() {
					...
					return (
						(this._inNavbar || this._config.display === 'static') &&
							(be.setDataAttribute(this._menu, 'popper', 'static'), (e.modifiers = [{ name: 'applyStyles', enabled: !1 }])),
					...
					for (const i of t) {
						...
						if (
							...
							(o._menu.contains(e.target) &&
								((e.type === 'keyup' && e.key === Ii) || /input|select|option|textarea|form/i.test(e.target.tagName)))
						)
							continue;
