...
export default function SidebarAdmin({ activeNav }: { activeNav: string[] }) {
	return (
		<div id='sidebar'>
			<div class='sidebar-wrapper active'>
				...
				<div class='sidebar-menu'>
					<ul class='menu'>
						...
						<li class={clsx('sidebar-item', activeNav[0] === 'composing' && 'active')}>
							<a href='/composing' class='sidebar-link'>
